...
export const updateData: ActionCreator<UpdateDataAction> = (data: Object | Array<Object>, applicationContainer: ApplicationContainers, container: AppContainers | ComponentsContainersEnum) => ({
...
export const reportError: ActionCreator<ReportErrorAction> = (error: string, applicationContainer: ApplicationContainers, container: AppContainers | ComponentsContainersEnum) => ({
...
export interface ChangeLoadingStateAction extends Action {
    ...
    container: AppContainers | ComponentsContainersEnum;
};
