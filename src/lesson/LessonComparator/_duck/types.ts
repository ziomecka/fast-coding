export enum LessonComparatorActionsEnum {
    LESSON_LESSON_COMPARATOR_REGISTER_NEW_KEY = '@@lesson_lessonComparator/REGISTER_NEW_KEY',
    LESSON_LESSON_COMPARATOR_REGISTER_ERROR = '@@lesson_lessonComparator/REGISTER_ERROR',
